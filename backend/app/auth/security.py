...
def normalize_email(email: str) -> str:
    """users.email/invitations.email are TEXT with case-sensitive (or no, for
    invitations) uniqueness, so "John@Example.com" and "john@example.com"
    could otherwise become two separate accounts, and a user who registered
    with mixed case couldn't log in with a lowercased address. Every write and
